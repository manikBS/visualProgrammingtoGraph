...
joint.shapes.quadEquation = {};
joint.shapes.quadEquation.Element = joint.shapes.devs.Model.extend({
    defaults: joint.util.deepSupplement({
        type: 'quadEquation.Element',
        attrs: {
            rect: { stroke: 'none', 'fill-opacity': 0 }
        },
        inPorts: ['in1','in2'],
...
joint.shapes.quadEquation.ElementView = joint.dia.ElementView.extend({
    template: [
        '<div class="slider-element">',
        '<button class="delete">x</button>',
        '<label>quadEquation</label><br/>',
        '<label>{in1}+{in2}x+...</label><br/>',
        '</div>'
    ].join(''),
